        ...
        this.$parent.getJson(`/api/cart`)
            .then(data => {
                for (let item of data.contents) {
                    item.imgPath = `img/products/s${item.id_product}.jpg`;
...
<a class="header__basket" @click="showCart = !showCart"><svg width="32" height="29" viewBox="0 0 32 29" xmlns="http://www.w3.org/2000/svg">
